...
const planContentClasses =
  "text-[13px] leading-6 text-[var(--text-primary)] [&_p]:my-2 [&_p:first-child]:mt-0 [&_p:last-child]:mb-0 [&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:my-3 [&_ol]:list-decimal [&_ol]:pl-6 [&_li]:my-1 [&_h1]:mt-4 [&_h1]:[font-family:var(--font-display)] [&_h1]:text-[1.35rem] [&_h2]:mt-4 [&_h2]:[font-family:var(--font-display)] [&_h2]:text-[1.15rem] [&_h3]:mt-3 [&_h3]:text-[1rem] [&_h3]:font-semibold [&_code]:rounded-[var(--radius-sm)] [&_code]:bg-[var(--bg-secondary)] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:[font-family:var(--font-mono)] [&_code]:text-[0.9em] [&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:rounded-[16px] [&_pre]:border [&_pre]:border-[var(--border-color)] [&_pre]:bg-[var(--bg-code)] [&_pre]:p-4 [&_pre]:[font-family:var(--font-mono)] [&_pre]:text-[var(--text-primary)] [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_blockquote]:my-3 [&_blockquote]:border-l-[3px] [&_blockquote]:border-[var(--border-color)] [&_blockquote]:pl-4 [&_blockquote]:text-[var(--text-muted)] [&_table]:my-3 [&_table]:w-full [&_table]:border-collapse [&_th]:border [&_th]:border-[var(--border-color)] [&_th]:bg-[var(--bg-secondary)] [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_td]:border [&_td]:border-[var(--border-color)] [&_td]:px-3 [&_td]:py-2";
